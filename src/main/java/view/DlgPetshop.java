...
@Log4j2
public class DlgPetshop extends javax.swing.JDialog {

    private int id = 0;
    private Produto produto = new Produto();
    private final SessionFactory sessionFactory;

    public DlgPetshop(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        pnlbackground.add(btncadastros, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 20, 150, 50));

        background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/telapetshop.png"))); // NOI18N
        pnlbackground.add(background, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, -1));
        ...
        pnlprodutos.add(btnNovo, new org.netbeans.lib.awtextra.AbsoluteConstraints(920, 660, -1, -1));
        ...
        pnlprodutos.add(btnSalvar, new org.netbeans.lib.awtextra.AbsoluteConstraints(990, 660, -1, -1));
        ...
        pnlConsulta.add(btnVerProduto, new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 640, -1, -1));
        ...
        pnlConsulta.add(btnEditar, new org.netbeans.lib.awtextra.AbsoluteConstraints(930, 640, -1, -1));
